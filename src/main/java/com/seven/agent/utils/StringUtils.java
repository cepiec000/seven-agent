...
public class StringUtils {
    ...
    public static String messageFormat(String messagePattern, Object[] argArray) {
    ...
    private static void deeplyAppendParameter(StringBuilder sbuf, Object o, Map<Object[], Object> seenMap) {
        if (o == null) {
            ...
            if (o instanceof Throwable) {
                String errorStack = LogStackString.errInfo((Exception) o);
                safeObjectAppend(sbuf, errorStack);
    ...
    private static void safeObjectAppend(StringBuilder sbuf, Object o) {
        try {
            ...
            System.out.println("SLF4J: Failed toString() invocation on an object of type [" + o.getClass().getName() + "]" + var3.getMessage());
